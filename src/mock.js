...
for (let i = 0; i < Random.integer(1, 20); i++) {
  let template = {
    'key':Random.natural(1, 100), // 生成1到100之间自然数
    'isShow': Random.boolean, // 可以生成基本数据类型
    'articleNum': Random.natural(1, 100), // 生成1到100之间自然数
    'categoryName': Random.name(), // 生成姓名
  }
  dataCategory.push(template)
}

Mock.mock('/rest/category','post',dataCategory)
...
for (let i = 0; i < Random.integer(1, 20); i++) {
  ...
  dataModules.push(template)
}

Mock.mock('/rest/modules','post',dataCategory)